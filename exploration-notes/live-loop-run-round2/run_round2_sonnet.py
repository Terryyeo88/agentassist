...
# T5.3-V round 2: reuse round-1 harness verbatim; ONLY change = model pin + output dir.
OUT = HERE / "runB-sonnet"
RAW = OUT / "raw"
...
def main() -> None:
    ...
    transport = make_live_transport(
        ctx=ctx, ledger=ledger, budget=budget, model="claude-sonnet-4-6",
